...
Wes Doyle used the open source [`en_core_web_sm` Named Entity Recognition model from `spaCy` for his web app.](https://spacy.io/models/en) . **All credit goes to Wes Doyle for writing the code, I merely forked his repo and fixed a few lines of broken code due to upgrades in the dependencies.**

![Web App](/screenshot_img/bill_evans_ner.gif)
*A little demo gif.*
...
- [What I learnt...](#what-i-learnt)
  ...
  - [What I learnt: Running single test cases](#what-i-learnt-running-single-test-cases)
  ...
  - [What I learnt: I git cloned Wes Doyle's project from github but it didn't work out of the box.](#what-i-learnt-i-git-cloned-wes-doyles-project-from-github-but-it-didnt-work-out-of-the-box)
...
At this time, Doyle shows a live coding example of the "Dependency Inversion Principle". It's the 'D' in SOLID Principles of object oriented programming. It's about making sure classes depend on abstractions not concretes. Here's an example using the `ner_client.py` file from the tutorial.
